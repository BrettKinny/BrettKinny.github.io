...
I'll write about whatever I feel like here. Probably some web development stuff since that's what I do. Maybe some opinions on tools and workflows. Maybe random thoughts about things that have nothing to do with code. The beauty of a personal blog is you don't have to stick to a niche.

The design philosophy is simple: content first, everything else second. If something doesn't serve the words on the page, it doesn't belong here. White space isn't wasted space. Restraint is a feature. Every element should earn its place.

That's it. That's the blog. Thanks for reading.
